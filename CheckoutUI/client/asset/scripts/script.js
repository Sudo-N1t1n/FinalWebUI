...
const deleteProducts = async() => {
    url = 'https://app.netlify.com/sites/sashankautobill/deploys';
    ...
    for (let product of products) {
        const response = await axios.delete(`hhttps://app.netlify.com/sites/sashankautobill/deploys/${product.id}`)
